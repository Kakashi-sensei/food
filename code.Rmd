...
model <- lmer(rsfMRI_Component1 ~ APOE_all + T40_Gcar + family_history_AD + Age_Baseline + Sex + 
                               BMI_Y08andY12andY14_mean + AlcoholY08 + SmokingY08 + Townsend + Folate_mean + APOE_all:Folate_mean + 
...
library(ggplot2)
# Assuming df is your data frame with the variables: Folate_mean, predicted values, and APOE_all
...
# Filter out rows where APOE_all is NA
...
file_path <- "C:/Users/timothy/OneDrive/Documents/ISU/food_project/output/VBs/figures/R/interaction_VB9_APOE_IC1.tiff"  # Change this to your desired file path
