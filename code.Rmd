...
for(suffix in suffixes) {
  columns <- paste(breadWithButt, suffix, sep="_") # creates a vector of column names with current suffix
...
# 3. merge pie:
pie_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthpie")
# calculate pie_* variables
for(suffix in suffixes) {
  columns <- paste(pie, suffix, sep="_") # creates a vector of column names with current suffix
...
# 4. merge dessert:
dessert_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthdessert")
# calculate dessert_* variables
for(suffix in suffixes) {
  columns <- paste(dessert, suffix, sep="_") # creates a vector of column names with current suffix
...
# 5. merge sweet:
sweet_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthsweet")
# calculate sweet_* variables
for(suffix in suffixes) {
  columns <- paste(sweet, suffix, sep="_") # creates a vector of column names with current suffix
...
# 6. merge savoury:
savoury_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthsavoury")
# calculate savoury_* variables
for(suffix in suffixes) {
  columns <- paste(savoury, suffix, sep="_") # creates a vector of column names with current suffix
...
# 7. merge soup:
soup_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthsoup")
# calculate soup_* variables
for(suffix in suffixes) {
  columns <- paste(soup, suffix, sep="_") # creates a vector of column names with current suffix
...
# 8. merge starchy:
starchy_vars <- c("NumberofsliceswithButt", "NumberbaguettewithButt", "NumberbapwithButt", "NumberbreadrollwithButt", "NumbercrackerwithButt", "NumberoatcakewithButt", "NumberOthstarchy")
# calculate starchy_* variables
for(suffix in suffixes) {
  columns <- paste(starchy, suffix, sep="_") # creates a vector of column names with current suffix
