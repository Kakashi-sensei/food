...
# Loop through each dependent variable and fit the model
for (var in dependent_vars) {
  
  # Construct the formula
  formula <- as.formula(paste(var, "~ APOE_all + T40_Gcar + family_history_AD + Age_Baseline + Sex + 
                             BMI_Y08andY12andY14_mean + AlcoholY08 + SmokingY08 + Townsend + Energy_mean + 
                             (1 | Assessment_0)"))
